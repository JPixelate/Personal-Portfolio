            ...
            <div className="relative pt-40 pb-20 px-8">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="mb-16">
                        ...
                        <p className="text-neutral-600 dark:text-gray-400 leading-relaxed text-base md:text-lg border-l-4 border-purple-500/50 pl-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {serviceData.features.map((feature, idx) => (
                                <motion.div
                                    key={idx}
                                    variants={itemVariants}
                                    className="flex items-start gap-4 bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/10 dark:border-white/10 hover:border-purple-500/30 transition-colors"
                                >
                    ...
                    <motion.div variants={itemVariants} className="mb-16">
                        ...
                        <div className="flex flex-wrap gap-4">
                            {serviceData.technologies.map((tech, idx) => (
                                <span
                                    key={idx}
                                    className="px-6 py-3 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-full text-base font-medium text-neutral-600 dark:text-gray-300 hover:border-purple-500/50 hover:bg-black/10 dark:hover:bg-white/10 transition-all"
                                >
                                    {tech}
                                </span>
                            ))}
                    ...
                    <motion.div variants={itemVariants} className="pt-8 border-t border-black/10 dark:border-white/10">
                        <button
                            ...
                            className="w-full py-5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold text-lg rounded-2xl hover:from-purple-500 hover:to-indigo-500 transition-all shadow-[0_0_40px_rgba(168,85,247,0.3)] flex items-center justify-center gap-3 group"
                        >
