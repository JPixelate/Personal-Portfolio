...
const AIAutomationPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white/75 dark:bg-neutral-950/75 text-neutral-900 dark:text-white selection:bg-purple-500/30 transition-colors duration-500 backdrop-blur-[2px]">
            <SEO 
