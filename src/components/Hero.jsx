  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className={`absolute inset-0 transition-opacity duration-700 ${isDark ? 'opacity-80' : themeMode === 'reading' ? 'opacity-40' : 'opacity-100'}`}>
          <div className={`absolute inset-0 [background-size:60px_60px] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_20%,#000,transparent)] ${themed(
        ...
        {/* Vignette Fades */}
        <div className={`absolute inset-0 transition-colors duration-700 ${themed(
        ...
        <div className={`absolute inset-0 transition-colors duration-700 ${themed(
          ...
          'bg-gradient-to-r from-[#0a0a0a] via-transparent to-[#0a0a0a]',
          'bg-gradient-to-r from-[#050505] via-transparent to-[#050505]',
          'bg-gradient-to-r from-[#fdf6e3] via-transparent to-[#fdf6e3]'
        )}`} />
      </div>
              ...
              <div className={`flex flex-col md:flex-row gap-12 items-start lg:items-center justify-between border-t pt-12 transition-colors duration-700 ${themed('border-neutral-100', 'border-neutral-800', 'border-blue-900/50', 'border-[#433422]/10')}`}>
                ...
                <div className="flex flex-col gap-2">
                   <div className="flex items-center gap-2">
                      ...
                      <span className={`text-sm font-bold uppercase tracking-widest transition-colors duration-700 ${themed('text-neutral-900', 'text-neutral-200', 'text-blue-400', 'text-[#433422]')}`}>Open to Work</span>
                   </div>
                   <span className={`text-xs font-medium transition-colors duration-700 ${themed('text-neutral-400', 'text-neutral-500', 'text-blue-900/60', 'text-[#433422]/40')}`}>Based in General Santos City, PH</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-4 order-1 lg:order-2 mb-20 lg:mb-0 pt-2 lg:pt-0">
             ...
             >
                ...
                <div className={`aspect-[4/5] lg:aspect-[3/5] rounded-2xl overflow-hidden shadow-2xl transition-all duration-700 border relative ${themed(
                  ...
                  'bg-[#e3d9c1] border-[#433422]/10 shadow-[#433422]/05'
                )}`}>
                   <img
                    src={meHero}
