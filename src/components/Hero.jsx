        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-end">
          ...
          <div className="lg:col-span-4 order-1 lg:order-2 mb-20 lg:mb-0 pt-2 lg:pt-0">
             ...
             >
                ...
                <div className={`absolute -top-8 right-0 sm:-top-12 sm:right-12 z-[30] px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-xl border flex items-center gap-3 sm:gap-3 scale-90 sm:scale-100 whitespace-nowrap transition-all duration-700 ${blueprintMode ? 'bg-[#050505] border-blue-500/50 text-blue-400' : 'bg-white border-neutral-100 text-neutral-900'}` }>
                ...
                {/* 2. AI - Left Side */}
                <div className={`absolute top-1/2 -left-2 sm:-top-4 sm:-left-20 z-[30] px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-xl border flex items-center gap-3 sm:gap-3 scale-90 sm:scale-100 whitespace-nowrap transition-all duration-700 ${blueprintMode ? 'bg-[#050505] border-blue-500/50 text-blue-400' : 'bg-white border-neutral-100 text-neutral-900'}`}>
                ...
                <div className={`absolute top-1/3 -right-2 sm:top-20 sm:-right-8 z-[30] px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-xl border flex items-center gap-3 sm:gap-3 scale-90 sm:scale-100 whitespace-nowrap transition-all duration-700 ${blueprintMode ? 'bg-[#050505] border-blue-500/50 text-blue-400' : 'bg-white border-neutral-100 text-neutral-900'}`}>
