...
export const ArchitectureViewer = () => {
    ...
    return (
        <motion.div
            ...
            className="fixed top-4 left-4 z-[100] hidden lg:flex flex-col gap-3 group"
        >
            <div className="flex items-center gap-2 border border-blue-500/30 bg-blue-500/5 backdrop-blur-sm p-3 rounded-xl shadow-2xl">
...
export const BlueprintStats = ({ componentName = "MainApp", bundleSize = '24.8kb', global = false }) => {
  ...
  return (
    <div className={global ? "fixed top-4 right-6 z-[100] hidden lg:block" : "absolute top-2 right-2 z-[60]"}>
      <div className="flex flex-col gap-2 border border-blue-500/40 bg-blue-500/5 text-blue-400 p-3 rounded-xl backdrop-blur-sm shadow-2xl transition-all hover:border-blue-500/60 min-w-[140px]">
         {/* Top Row: Info */}
         <div className="flex items-center justify-between border-b border-blue-500/20 pb-2">
            <div className="flex items-center gap-1.5">
               <Activity size={10} className="text-blue-500 animate-pulse" />
               <span className="font-mono text-[9px] font-bold tracking-tighter">{fps} FPS</span>
            </div>
            <div className="h-3 w-px bg-blue-500/20" />
            <div className="flex items-center">
               <span className="font-mono text-[9px] font-bold tracking-tighter uppercase opacity-80">{bundleSize}</span>
            </div>
         </div>
         ...
         <button 
           ...
           className="flex items-center justify-center gap-2 py-1.5 rounded-lg bg-blue-500/10 hover:bg-blue-600 hover:text-white transition-all group/btn"
         >
            <Code size={10} className="group-hover/btn:scale-110 transition-transform" />
            <span className="font-mono text-[9px] uppercase font-black tracking-widest">Source_Code</span>
         </button>
      </div>
